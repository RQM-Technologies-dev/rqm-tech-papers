# qsp-002-right-sided-quaternion-fourier-transform

This folder is a semantic paper package for:

**A Stable Right-Sided Quaternion Fourier Regime for Multichannel Spectral Analysis**

## Source of truth

- Authoritative paper text source: `main.tex`
- `index.html` is the clean package landing page for `/papers/qsp-002-right-sided-quaternion-fourier-transform/`.
