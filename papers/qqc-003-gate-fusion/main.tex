...
\emph{A Canonical Quaternionic Intermediate Representation for Single-Qubit Quantum Circuits}. A maximal run of adjacent single-qubit gates on
...
Paper 1 in this series, \emph{Foundations of Quaternionic Quantum Computing: Qubits, Spinors, and SU(2) Geometry}, established the fixed
quaternion--$\SU(2)$ convention used throughout the repository. Paper 2,
\emph{A Canonical Quaternionic Intermediate Representation for Single-Qubit Quantum Circuits}, defined a canonical single-qubit intermediate
