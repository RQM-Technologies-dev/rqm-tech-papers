...
using the canonical quaternionic intermediate representation defined in a Canonical Quaternionic Intermediate Representation}. A maximal run of adjacent single-qubit gates on
...
Foundations of Quaternionic Quantum Computing  established the fixed
quaternion--$\SU(2)$ convention used throughout the repository. A Canonical Quaternionic Intermediate Representation, defined a canonical single-qubit intermediate
