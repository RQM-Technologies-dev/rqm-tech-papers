# qsp-003-coherence-and-s3-orientation-metrics

This folder is a semantic paper package for:

**Quaternionic Coherence and S^3 Orientation Metrics for Multichannel Wave Analysis**

## Source of truth

- Authoritative paper text source: `main.tex`
- `index.html` is the clean package landing page for `/papers/qsp-003-coherence-and-s3-orientation-metrics/`.
