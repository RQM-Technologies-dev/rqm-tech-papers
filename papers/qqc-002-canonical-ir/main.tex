...
\newcommand{\foundationstitle}{\href{../qqc-001-foundations/paper.pdf}{\textcolor{black}{\emph{Foundations of Quaternionic Quantum Computing}}}}
...
correspondence established in \foundationstitle, it treats the
...
deterministic normalization and canonization rules. The canonical
...
The first paper in this series, \foundationstitle, established a
...
\foundationstitle. Single-qubit gates live fundamentally in
...
\foundationstitle. Choose $\chi$ such that
...
The quaternion convention is also inherited from \foundationstitle:
\begin{equation}
...
\begin{proof}
This is the standard result established in \foundationstitle. The key points are that
...
\begin{proof}
By the convention carried forward from \foundationstitle,
\[
