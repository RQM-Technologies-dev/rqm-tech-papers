...
correspondence established in \emph{Foundations of Quaternionic Quantum Computing}, it treats the
...
The first paper in this series, \emph{Foundations of Quaternionic Quantum Computing}, established a
...
\section{Background and dependency on Foundations of Quaternionic Quantum Computing}

\subsection{Gates, phase, and the fixed convention}

We carry forward without modification the convention fixed in
\emph{Foundations of Quaternionic Quantum Computing}. Single-qubit gates live fundamentally in
...
\emph{Foundations of Quaternionic Quantum Computing}. Choose $\chi$ such that
...
The quaternion convention is also inherited from \emph{Foundations of Quaternionic Quantum Computing}:
\begin{equation}
...
\begin{proof}
This is the standard result established in \emph{Foundations of Quaternionic Quantum Computing}. The key points are that
...
\begin{proof}
By the convention carried forward from \emph{Foundations of Quaternionic Quantum Computing},
\[
