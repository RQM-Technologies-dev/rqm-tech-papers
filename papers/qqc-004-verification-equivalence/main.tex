...
\section{Background and dependency on papers 1--3}

Paper 1 fixed the quaternion--$\SU(2)$ convention:
\begin{equation}
...
Paper 2 defined the canonical IR object
\[
\uoneq(w,x,y,z)
\]
...
Paper 3 defined the local fusion operator for single-qubit segments
\[
